    ...
    return Controller.extend("kyra001.pages.access.AccessPage", {
        onInit() {
            ...
            const oModel = new JSONModel({
                ...
                // Button Visibility State (In-Page Toggle without navigating away)
        ...
        // --- BUTTON METHOD: TOGGLE ADD ACCESS BUSINESS SECTOR ON THIS PAGE ---
        onOpenAddAccessDialog() {
            const oModel = this.getView().getModel("accessModel");
            oModel.setProperty("/showAddAccessSector", true);
            oModel.setProperty("/showRemoveAccessSector", false);
            MessageToast.show("Business Sector Add Access form displayed below.");
        },
        ...
        // --- BUTTON METHOD: TOGGLE REMOVE ACCESS SECTOR ON THIS PAGE ---
        ...
        onAddAccessSubmit() {
            ...
            MessageBox.success("Access Request " + sReqId + " for '" + oForm.roleName + "' submitted successfully! Routed for role owner approval.", {
                ...
                onClose: () => {
                    // Navigate to My Requests tab automatically to track progress
            ...
            MessageBox.confirm("Are you sure you want to request revocation for role '" + oData.roleName + "' on " + oData.system + "?", {
                ...
                onClose: (sAction) => {
                    if (sAction === MessageBox.Action.OK) {
                        ...
                        // Navigate to My Requests tab automatically
                        const oTabBar = this.byId("accessIconTabBar");
                        oTabBar.setSelectedKey("myRequests");
                    }
                }
