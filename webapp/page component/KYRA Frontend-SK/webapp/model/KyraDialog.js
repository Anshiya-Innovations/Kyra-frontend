        ...
        show(options) {
            ...
            card.innerHTML = `
                ...
                <div style="padding: 14px 22px; background: #F8FAFC; border-top: 1px solid #F1F5F9; display: flex; justify-content: flex-end; gap: 10px; align-items: center; flex-shrink: 0;">
                    ${hasSecondary ? `<button id="kyra_dialog_cancel_btn" style="height: 38px; min-height: 38px; min-width: 100px; padding: 0 20px; border-radius: 8px; border: 1.5px solid #CBD5E1; background: #FFFFFF; color: #334155; font-weight: 600; font-size: 13.5px; font-family: inherit; cursor: pointer; box-shadow: 0 1px 3px rgba(15, 23, 42, 0.05); transition: all 0.18s cubic-bezier(0.16, 1, 0.3, 1); display: inline-flex; align-items: center; justify-content: center;" onmouseover="this.style.borderColor='#94A3B8';this.style.background='#F8FAFC';this.style.color='#0F172A';this.style.transform='translateY(-1.5px)';this.style.boxShadow='0 3px 8px rgba(15, 23, 42, 0.1)';" onmouseout="this.style.borderColor='#CBD5E1';this.style.background='#FFFFFF';this.style.color='#334155';this.style.transform='translateY(0)';this.style.boxShadow='0 1px 3px rgba(15, 23, 42, 0.05)';" onmousedown="this.style.transform='scale(0.97)';" onmouseup="this.style.transform='translateY(-1.5px)';">${secondaryButtonText}</button>` : ''}
                    <button id="kyra_dialog_confirm_btn" style="height: 38px; min-height: 38px; min-width: 120px; padding: 0 24px; border-radius: 8px; border: 1px solid ${btnColor}; background: ${btnColor}; color: #FFFFFF; font-weight: 600; font-size: 13.5px; font-family: inherit; letter-spacing: 0.015em; cursor: pointer; box-shadow: 0 2px 8px rgba(0, 140, 156, 0.28); transition: all 0.18s cubic-bezier(0.16, 1, 0.3, 1); display: inline-flex; align-items: center; justify-content: center;" onmouseover="this.style.background='${btnHoverColor}';this.style.borderColor='#01C3D0';this.style.boxShadow='0 4px 14px rgba(0, 195, 208, 0.45)';this.style.transform='translateY(-1.5px)';" onmouseout="this.style.background='${btnColor}';this.style.borderColor='${btnColor}';this.style.boxShadow='0 2px 8px rgba(0, 140, 156, 0.28)';this.style.transform='translateY(0)';" onmousedown="this.style.transform='scale(0.97)';" onmouseup="this.style.transform='translateY(-1.5px)';">${buttonText}</button>
                </div>
            `;
