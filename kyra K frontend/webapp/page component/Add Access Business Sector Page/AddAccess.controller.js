sap.ui.define([
    ...
    return Controller.extend("kyra001.pages.addAccessBusinessSector.AddAccess", {
        ...
        async onGoToStep3Summary() {
            ...
            try {
                const res = await fetch("/odata/v4/auth/Requests");
                ...
                console.error("Error fetching existing requests from database:", e);
            } finally {
        ...
        async onFinalSubmitRequest() {
            ...
            try {
                ...
                console.error("Database persistence fetch error:", err);
            } finally {
                sap.ui.core.BusyIndicator.hide();
            }
